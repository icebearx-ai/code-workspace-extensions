...
const EXTENSION_ID = "zhuiyi-guangda-coding-spec";
...
function main() {
  ...
  if (context.tools.includes("codex")) {
    ...
    copyAssetDirectory(outputRoot, "assets/original-specs", "codex/assets/original-specs");
  ...
  if (context.tools.includes("claude")) {
    ...
    copyAssetDirectory(outputRoot, "assets/original-specs", "claude/assets/original-specs");
